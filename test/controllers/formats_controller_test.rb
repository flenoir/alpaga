...
class FormatsControllerTest < ActionController::TestCase
  ...
  test "should create format" do
    assert_difference('Format.count') do
      post :create, format: { compression: @format.compression, name: @format.name, resolution: @format.resolution, usage: @format.usage }
    end
  ...
  test "should update format" do
    patch :update, id: @format, format: { compression: @format.compression, name: @format.name, resolution: @format.resolution, usage: @format.usage }
    assert_redirected_to format_path(assigns(:format))
  end
